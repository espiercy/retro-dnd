...
| Rule Card approval (`CHAR-001`, `CHAR-002`, `CHAR-003`, `CHAR-007`) | **Not granted — all four `AWAITING_APPROVAL`**, and all four **mechanically complete, `READY FOR HUMAN RULE-CARD REVIEW`**. Approving `CHAR-003` ratifies SR-1; approving `CHAR-001` ratifies SR-2, SR-3, SR-4 and SR-5 |
