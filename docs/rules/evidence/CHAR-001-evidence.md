...
>
> **Wording clarification (2026-09-05) — already-captured evidence, NOT new source discovery.** §4's "A. Die method" row records the p. 6 bound as *"3 stated as the least and 18 the highest possible"*, and the 2026-08-23 banner above records p. 130's as *"the 3–18 range still applying"*. Both statements were captured; both were **flattened**, losing RC's generality markers. RC's exact words are:
>
> - **p. 6** — *"if you roll ones each time, then the total score is 3, the least score possible. If you roll all sixes, then the total is 18, **the highest score you can have**. You should end up with six numbers, each between 3 and 18."*
> - **p. 130** — *"Of course, **the range limitation of 3 to 18 for ability scores** still applies."*
>
> **The §4 row is deliberately NOT rewritten.** Its flattened wording is the provenance of the composition defect found at the Pre-Code gate and must remain readable as written. **No new completeness certification is claimed, no completeness gate is reopened, and `DEC-0010`'s independent review of this packet stands unchanged** — this clarification adds no object, no page, and no finding. It records exact wording for two objects the packet already held. Consumed by `CHAR-001` §4 **R11** (amended 2026-09-05).
>
